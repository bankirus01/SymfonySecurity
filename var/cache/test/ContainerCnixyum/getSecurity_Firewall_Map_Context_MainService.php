...
return $this->services['security.firewall.map.context.main'] = new \Symfony\Bundle\SecurityBundle\Security\FirewallContext(new RewindableGenerator(function () {
    ...
    yield 3 => ${($_ = isset($this->services['security.authentication.listener.simple_form.main']) ? $this->services['security.authentication.listener.simple_form.main'] : $this->load(__DIR__.'/getSecurity_Authentication_Listener_SimpleForm_MainService.php')) && false ?: '_'};
