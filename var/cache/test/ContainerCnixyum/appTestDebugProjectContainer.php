...
class appTestDebugProjectContainer extends Container
{
    ...
    public function __construct(array $buildParameters = array())
    {
        ...
        $this->normalizedIds = array(
            ...
            'appbundle\\security\\passwordauthenticator' => 'AppBundle\\Security\\PasswordAuthenticator',
        ...
        $this->fileMap = array(
            ...
            'AppBundle\\Form\\ArticleType' => __DIR__.'/getArticleTypeService.php',
            'AppBundle\\Form\\UserType' => __DIR__.'/getUserTypeService.php',
            'AppBundle\\Security\\PasswordAuthenticator' => __DIR__.'/getPasswordAuthenticatorService.php',
            ...
            'security.authentication.listener.simple_form.main' => __DIR__.'/getSecurity_Authentication_Listener_SimpleForm_MainService.php',
            'security.authentication.provider.anonymous.main' => __DIR__.'/getSecurity_Authentication_Provider_Anonymous_MainService.php',
            'security.authentication.provider.simple_form.main' => __DIR__.'/getSecurity_Authentication_Provider_SimpleForm_MainService.php',
            ...
            'security.user.provider.concrete.my_db_provider' => __DIR__.'/getSecurity_User_Provider_Concrete_MyDbProviderService.php',
            ...
            'service_locator.psaqjhp' => __DIR__.'/getServiceLocator_PsaqjhpService.php',
        ...
        $this->privates = array(
            ...
            'AppBundle\\Security\\PasswordAuthenticator' => true,
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('dM9htDvZPT', 0, ($this->targetDirs[0].'/pools'));
    ...
    {
        return $this->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4qLrZdo6sm', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.annotations'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('4tb75osVB5', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('b+lIk3jOOC', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('wr6NN160FD', 0, $this->getParameter('container.build_id'), ($this->targetDirs[0].'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->getMonolog_Logger_CacheService()) && false ?: '_'}));
    }
    ...
    {
        return $this->services['fragment.listener'] = new \Symfony\Component\HttpKernel\EventListener\FragmentListener(${($_ = isset($this->services['uri_signer']) ? $this->services['uri_signer'] : $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('ff328d0a39586d950958bb8dd9440fa5624574ed')) && false ?: '_'}, '/_fragment');
    }
    ...
    protected function getSecurity_Authentication_ManagerService()
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['security.authentication.provider.simple_form.main']) ? $this->services['security.authentication.provider.simple_form.main'] : $this->load(__DIR__.'/getSecurity_Authentication_Provider_SimpleForm_MainService.php')) && false ?: '_'};
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('ff328d0a39586d950958bb8dd9440fa5624574ed');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => 'ff328d0a39586d950958bb8dd9440fa5624574ed',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => 'ff328d0a39586d950958bb8dd9440fa5624574ed',
